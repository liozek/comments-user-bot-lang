module.exports = {
	...
	CommentsInline: 'Comentários ${emoji.speech_balloon}',
	ChannelInline: 'Canal ${emoji.arrow_heading_up}️️',
	NewComment: 'Escreva seu comentário',
	Published: 'Publicado',
	Tip15min: [
		'Dica: adicione mais conteúdo a este comentário - escreva com formatação, emoji, ',
		'sticker, foto, em 15 minutos'
	],
	YourComment: 'Seu comentário',
	deleted: 'apagado',
	NotFoundComment: 'Seu comentário não foi encontrado. Tente novamente mais tarde. Os robôs serão punidos por isso',
	WhoCanDelete: 'O proprietário ou administradores do canal podem apagar comentários',
	Settings: 'Configurações do canal ${emoji.gear}, escolha a ação desejada',
	BotWorksAuto: 'Bot ${emoji.robot_face} funciona automaticamente',
	CommentsAsSinglePost: 'Comentários ${emoji.speech_balloon} em uma postagem separada',
	AddCommentsToPost: 'Adicionar comentários ${emoji.speech_balloon} à postagem',
